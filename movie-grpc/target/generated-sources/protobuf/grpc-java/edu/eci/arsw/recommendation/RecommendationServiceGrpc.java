...
public final class RecommendationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.recommendation.RecommendationRequest,
      edu.eci.arsw.recommendation.RecommendationList> getGetRecommendationsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRecommendations",
      requestType = edu.eci.arsw.recommendation.RecommendationRequest.class,
      responseType = edu.eci.arsw.recommendation.RecommendationList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.recommendation.RecommendationRequest,
      edu.eci.arsw.recommendation.RecommendationList> getGetRecommendationsMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.recommendation.RecommendationRequest, edu.eci.arsw.recommendation.RecommendationList> getGetRecommendationsMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getGetRecommendationsMethod = RecommendationServiceGrpc.getGetRecommendationsMethod) == null) {
          RecommendationServiceGrpc.getGetRecommendationsMethod = getGetRecommendationsMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.recommendation.RecommendationRequest, edu.eci.arsw.recommendation.RecommendationList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetRecommendations"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.recommendation.RecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.recommendation.RecommendationList.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getRecommendations(edu.eci.arsw.recommendation.RecommendationRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.recommendation.RecommendationList> responseObserver) {
  ...
  public static final class RecommendationServiceStub
    ...
    /**
     */
    public void getRecommendations(edu.eci.arsw.recommendation.RecommendationRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.recommendation.RecommendationList> responseObserver) {
  ...
  public static final class RecommendationServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.recommendation.RecommendationList getRecommendations(edu.eci.arsw.recommendation.RecommendationRequest request) {
  ...
  public static final class RecommendationServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.recommendation.RecommendationList> getRecommendations(
        edu.eci.arsw.recommendation.RecommendationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_RECOMMENDATIONS:
          serviceImpl.getRecommendations((edu.eci.arsw.recommendation.RecommendationRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.recommendation.RecommendationList>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.recommendation.RecommendationRequest,
              edu.eci.arsw.recommendation.RecommendationList>(
  ...
  private static abstract class RecommendationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.eci.arsw.recommendation.RecommendationProto.getDescriptor();
    }
