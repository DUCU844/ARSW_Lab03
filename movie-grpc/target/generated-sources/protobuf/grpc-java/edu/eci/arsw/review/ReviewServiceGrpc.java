...
public final class ReviewServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.review.ReviewRequest,
      edu.eci.arsw.review.ReviewList> getGetReviewsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetReviews",
      requestType = edu.eci.arsw.review.ReviewRequest.class,
      responseType = edu.eci.arsw.review.ReviewList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.review.ReviewRequest,
      edu.eci.arsw.review.ReviewList> getGetReviewsMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.review.ReviewRequest, edu.eci.arsw.review.ReviewList> getGetReviewsMethod;
      ...
      synchronized (ReviewServiceGrpc.class) {
        if ((getGetReviewsMethod = ReviewServiceGrpc.getGetReviewsMethod) == null) {
          ReviewServiceGrpc.getGetReviewsMethod = getGetReviewsMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.review.ReviewRequest, edu.eci.arsw.review.ReviewList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetReviews"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.review.ReviewRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.review.ReviewList.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getReviews(edu.eci.arsw.review.ReviewRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.review.ReviewList> responseObserver) {
  ...
  public static final class ReviewServiceStub
    ...
    /**
     */
    public void getReviews(edu.eci.arsw.review.ReviewRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.review.ReviewList> responseObserver) {
  ...
  public static final class ReviewServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.review.ReviewList getReviews(edu.eci.arsw.review.ReviewRequest request) {
  ...
  public static final class ReviewServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.review.ReviewList> getReviews(
        edu.eci.arsw.review.ReviewRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REVIEWS:
          serviceImpl.getReviews((edu.eci.arsw.review.ReviewRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.review.ReviewList>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.review.ReviewRequest,
              edu.eci.arsw.review.ReviewList>(
  ...
  private static abstract class ReviewServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.eci.arsw.review.ReviewProto.getDescriptor();
    }
